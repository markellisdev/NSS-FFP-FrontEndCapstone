...
app.factory('NumFactory', () => {

// Converts numbers to words, i.e. 3=three, courtesy of Stephen Chapman's post ---> http://javascript.about.com/od/hintsandtips/fl/How-to-Convert-Numbers-to-Words-with-JavaScript.htm
	...
	for (var i=0; i < x; i++) {
		if ((x-i)%3==2) {
  		...
  		if ((x-i)%3==1) {if (sk) str += th[(x-i-1)/3] + ' ';sk=0;}} if (x != s.length) {
  				...
  				for (i=x+1; i<y; i++) str += dg[n[i]] +' ';} return str.replace(/\s+/g,' ');}
